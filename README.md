...
| Linux x86_64 (glibc) -> [stringer-1.2.0-x86_64-linux-gnu.tar.gz](https://github.com/Skywolf-re/stringer/releases/latest/download/stringer-1.2.0-x86_64-linux-gnu.tar.gz) |  
| Linux x86_64 (musl) -> [stringer-1.2.0-x86_64-linux-musl.tar.gz](https://github.com/Skywolf-re/stringer/releases/latest/download/stringer-1.2.0-x86_64-linux-musl.tar.gz) |  
| Linux aarch64 (musl) -> [stringer-1.2.0-aarch64-linux-musl.tar.gz](https://github.com/Skywolf-re/stringer/releases/latest/download/stringer-1.2.0-aarch64-linux-musl.tar.gz) |  
| macOS arm64 -> [stringer-1.2.0-aarch64-macos.tar.gz](https://github.com/Skywolf-re/stringer/releases/latest/download/stringer-1.2.0-aarch64-macos.tar.gz) |  
| macOS x86_64 -> [stringer-1.2.0-x86_64-macos.tar.gz](https://github.com/Skywolf-re/stringer/releases/latest/download/stringer-1.2.0-x86_64-macos.tar.gz) |  
